...
const DeleteIndividual = ({ handleClose, individualData }) => {
    const [loading, setLoading] = useState(false)

    console.log(individualData, "mask")
    ...
    const submitForm = async () => {
        ...
        try {
            ...
            const orgDocRef = doc(db, 'users', individualData.id);
  ...
  return (
    <div className='bg-[#fff] w-[300px] h-[200px] mt-[100px] flex flex-col items-center p-8 gap-8 rounded-lg'>
        <p className='text-center text-lg font-medium font-merri '>Are you sure you want to delete this Individual?</p>
